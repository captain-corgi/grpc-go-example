...
type RouteGuideServer struct {
	//Embeded struct of gRPC api
	pb.UnimplementedRouteGuideServer

	//savedFeatures represent for repository
	savedFeatures []*pb.Feature // Read-only after initial
}

//NewRouteGuideServer return new RouteGuide server
func NewRouteGuideServer() *RouteGuideServer {
	sv := &RouteGuideServer{} // Create new server instance.
	sv.loadFeatures("")       // Load data. This line will be replaced by repository registration.
	return sv
}
...
var exampleData = []byte(`[{
    ...
    "name": "26, tổ 7, khu phố 6, đường Đông Bắc, phường Tân Chánh Hiệp, quận 12, TP HCM, Việt Nam"
}, {
    "location": {
        "latitude": 408122808,
        "longitude": -743999179
